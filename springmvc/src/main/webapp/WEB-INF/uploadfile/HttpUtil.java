...
public class HttpUtil {
	...
	/** 日志 */
	private static final com.opensymphony.xwork2.util.logging.Logger LOG = LoggerFactory.getLogger(HttpUtil.class);
	
	/**
	 * post调用 http返回字符串
	 * @param xmlInfo 参数 例如  name=yan&sex=0
